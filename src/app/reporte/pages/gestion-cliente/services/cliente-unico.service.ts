...
export class ClienteUnicoService {
  ...
  constructor(
    ...
    this.urlEndPoint = environment.urlUniqueClient;
  ...
  getToken(): Observable<Token> {
    const params = { client_id: this.client_id, client_secret: this.client_secret, grant_type: 'client_credentials' };
    return this.http.post<Token>(
      `${this.urlEndPoint}/oauth2/token`, {}, { params }
    );
  }
